...
[Latest Draft (11.02.25)](files/documents/Manuscript.pdf){target=_blank .btn .btn-primary .btn-lg .cv-download} [Presentation](presentation/00-slides-compilation.html){target=_blank .btn .btn-primary .btn-lg .cv-download}
...
![](files/images/main-ames-results-alt.jpeg){fig-align="right" width=450px height=400px}
